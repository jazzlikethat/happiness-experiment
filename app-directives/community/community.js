(function () {
    ...
    angular
        .module('app')
        .directive('appCommunity', Community);

    Community.$inject = ['$http', 'AppGlobalConstants', '$rootScope'];
    function Community($http, AppGlobalConstants, $rootScope) {
        return {
            restrict: 'EA',
            templateUrl: './app-directives/community/community.html',
